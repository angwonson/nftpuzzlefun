...
Future<
    Tuple4<List<Uint8List>, List<Tuple2<int, int>>, Tuple2<int, int>,
        Uint8List>> splitPuzzleImage({
  ...
  final myTuple = Tuple4<List<Uint8List>, List<Tuple2<int, int>>,
      Tuple2<int, int>, Uint8List>(
    outputImageList,
    outputImageSizeList,
